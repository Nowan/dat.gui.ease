  ...
  var GUIController = /*#__PURE__*/function (_dat$controllers$Cont) {
    ...
    _createClass(GUIController, [{
      ...
      value: function _onCurvePresetSelected(nextCurve) {
        ...
        var nextPreset = this._model.getMatchingPreset(nextCurve, nextOrientation).clone();
      ...
      value: function _onOrientationPresetSelected(nextOrientation) {
        var nextPreset = this._model.getMatchingPreset(this._model.activePreset.curve, nextOrientation).clone();
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var Point = /*#__PURE__*/function () {
    ...
    _createClass(Point, [{
      ...
      key: "set",
      value: function set(xOrPointLike, y) {
        if (_typeof(xOrPointLike) === "object") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var EasePresetProvider = /*#__PURE__*/function () {
    function EasePresetProvider(samplePreset) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var Middleware = /*#__PURE__*/function () {
    ...
    _createClass(Middleware, [{
      ...
      key: "preset",
      value: function preset(nativeEasePreset, thirdPartyEaseOrPredicateFunction) {
        switch (_typeof(thirdPartyEaseOrPredicateFunction)) {
          case "function":
            for (var _len = arguments.length, followupArguments = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
              followupArguments[_key - 2] = arguments[_key];
            }

            this._predicatePreset.apply(this, [nativeEasePreset, thirdPartyEaseOrPredicateFunction].concat(followupArguments));
      ...
      value: function _predicatePreset(nativeEasePreset, predicateFunction, thirdPartyToNativeCast, nativeToThirdPartyCast) {
        this.castEntries.push(_PredicateCastEntry["default"].of.apply(_PredicateCastEntry["default"], arguments));
      }
    }, {
      key: "_instancePreset",
      value: function _instancePreset(nativeEasePreset, thirdPartyEase) {
...
(function (global, factory) {
  ...
  var InstanceCastEntry = /*#__PURE__*/function (_CastEntry) {
    ...
    function InstanceCastEntry(nativeEasePresetOrPresetProvider, thirdPartyEase) {
      var _this;
...
(function (global, factory) {
  ...
  var PredicateCastEntry = /*#__PURE__*/function (_CastEntry) {
    ...
    function PredicateCastEntry(nativeEasePresetOrPresetProvider, predicateFunction, thirdPartyToNativeCast, nativeToThirdPartyCast) {
      var _this;
