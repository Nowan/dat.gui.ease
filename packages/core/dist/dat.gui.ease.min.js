...
(function (global, factory) {
  ...
  var GUIController = /*#__PURE__*/function (_dat$controllers$Cont) {
    ...
    function GUIController(object, property, middleware) {
      ...
      _this._view = new _GUIView["default"](_this._model.curves);
...
(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./composites/Anchor */ "./src/gui/model/ease/composites/Anchor.js"), __webpack_require__(/*! ./composites/Handle */ "./src/gui/model/ease/composites/Handle.js"), __webpack_require__(/*! ./composites/Point */ "./src/gui/model/ease/composites/Point.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _Anchor, _Handle, _Point) {
  "use strict";
    ...
    _createClass(Ease, [{
      ...
      get: function get() {
        ...
        for (var i = 0; i < this.anchors.length; i += 2) {
          ...
          points.push(_Point["default"].of(startAnchor), _Point["default"].of(startAnchor.handle), _Point["default"].of(endAnchor.handle), _Point["default"].of(endAnchor));
        }
      ...
      value: function fromSVGPath(svgPath) {
        ...
        ease.anchors[0] = new _Anchor["default"](startX, startY);
        ease.anchors[0].handle.x = cCoords[0];
        ease.anchors[0].handle.y = cCoords[1];

        for (var i = 2; i < cCoords.length - 4; i += 6) {
          var a = (i - 2) / 3 + 1;
          ease.anchors[a] = new _Anchor["default"](cCoords[i + 2], cCoords[i + 3]);
          ease.anchors[a].handle.x = cCoords[i];
          ease.anchors[a].handle.y = cCoords[i + 1];
          ease.anchors[a + 1] = new _Anchor["default"](cCoords[i + 2], cCoords[i + 3]);
          ease.anchors[a + 1].handle.x = cCoords[i + 4];
          ease.anchors[a + 1].handle.y = cCoords[i + 5];
        }

        var lastAnchor = _construct(_Anchor["default"], _toConsumableArray(cCoords.slice(-2)));
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var EasePreset = /*#__PURE__*/function () {
    function EasePreset(easeOrSvgPath) {
      ...
      this.ease = easeOrSvgPath instanceof _Ease["default"] ? easeOrSvgPath : _Ease["default"].fromSVGPath(easeOrSvgPath);
      this.curve = curve;
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./EasePreset */ "./src/gui/model/preset/EasePreset.js"), __webpack_require__(/*! ./enum/Curve */ "./src/gui/model/preset/enum/Curve.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _EasePreset, _Curve) {
  "use strict";
...
(function (global, factory) {
  ...
  var BackInOut = _EasePresetProvider["default"].ofSample(_EasePreset["default"].of("M 0,0 C 0.68,-0.6 0.32,1.6 1,1", _EasePreset.Curve.BACK, _EasePreset.Orientation.IN_OUT)); // export const Linear = EasePreset.of("M 0,0 C 0,0 1,1 1,1", Curve.LINEAR, Orientation.NONE);
...
(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./dom/gui.html */ "./src/gui/view/dom/gui.html"), __webpack_require__(/*! ./GUIViewEvent */ "./src/gui/view/GUIViewEvent.js"), __webpack_require__(/*! ./dom/directors/EasePanelDirector */ "./src/gui/view/dom/directors/EasePanelDirector.js"), __webpack_require__(/*! ./HTMLElementDirector */ "./src/gui/view/HTMLElementDirector.js"), __webpack_require__(/*! ./dom/directors/EaseEditorDirector */ "./src/gui/view/dom/directors/EaseEditorDirector.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _gui, _GUIViewEvent, _EasePanelDirector, _HTMLElementDirector2, _EaseEditorDirector) {
  "use strict";
    ...
    _createClass(GUIView, [{
      ...
      value: function openEditor(initialEase) {
        ...
        this._easeEditorDirector.on(_GUIViewEvent["default"].ACCEPT_EASE_EDIT_CLICKED, function () {
          ...
          return _this5.emit.apply(_this5, [_GUIViewEvent["default"].ACCEPT_EASE_EDIT_CLICKED].concat(args));
        });
        ...
        this._easeEditorDirector.on(_GUIViewEvent["default"].DISCARD_EASE_EDIT_CLICKED, function () {
          ...
          return _this5.emit.apply(_this5, [_GUIViewEvent["default"].DISCARD_EASE_EDIT_CLICKED].concat(args));
        });
        ...
        this._easeEditorDirector.on(_GUIViewEvent["default"].EASE_MODIFIED, function () {
          ...
          return _this5.emit.apply(_this5, [_GUIViewEvent["default"].EASE_MODIFIED].concat(args));
        });
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ./cast/PresetCastEntry */ "./src/middleware/cast/PresetCastEntry.js"), __webpack_require__(/*! ./cast/TransformCastEntry */ "./src/middleware/cast/TransformCastEntry.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _PresetCastEntry, _TransformCastEntry) {
  "use strict";
  ...
  _exports["default"] = void 0;
  _PresetCastEntry = _interopRequireDefault(_PresetCastEntry);
    ...
    _createClass(Middleware, [{
      ...
      get: function get() {
        return this._castEntries.filter(function (castEntry) {
          return castEntry instanceof _PresetCastEntry["default"];
        }).map(function (entry) {
          return entry.preset;
        });
      }
      ...
      value: function preset(thirdPartyEase, nativeEasePreset) {
        this.castEntries.push(_PresetCastEntry["default"].of(thirdPartyEase, nativeEasePreset));
        return this;
      }
    }, {
      key: "pick",
      ...
      value: function transform(thirdPartyToNativeCast, nativeToThirdPartyCast) {
        this.castEntries.push(_TransformCastEntry["default"].of(thirdPartyToNativeCast, nativeToThirdPartyCast));
        return this;
      }
    }, {
  ...
  var PresetCastEntry = /*#__PURE__*/function (_CastEntry) {
    ...
    _createClass(PresetCastEntry, [{
      ...
      value: function _parseNativePreset(rawNativePreset) {
        if (rawNativePreset instanceof _EasePresetProvider["default"]) {
          return rawNativePreset.next();
        } else if (rawNativePreset instanceof _EasePreset["default"]) {
