...
(function (global, factory) {
  ...
  var GUIController = /*#__PURE__*/function (_dat$controllers$Cont) {
    ...
    function GUIController(object, property, middleware) {
      ...
      _this._view.on(_GUIView.GUIViewEvent.CONFIG_PROPERTY_MODIFIED, _this._onConfigPropertyModified.bind(_assertThisInitialized(_this)));
    ...
    _createClass(GUIController, [{
      ...
      key: "_onConfigPropertyModified",
      value: function _onConfigPropertyModified(propertyName, propertyValue) {
        console.log(propertyName, propertyValue); // this._model.activePreset.config[propertyName] = propertyValue;
...
(function (global, factory) {
  ...
  // consider switching entire Ease class to bezier-js 
  var Ease = /*#__PURE__*/function () {
    ...
    _createClass(Ease, [{
      ...
      value: function clone() {
        return Ease.of.apply(Ease, _toConsumableArray(this._anchors.map(function (anchor) {
          return anchor.clone();
        })));
      }
    }], [{
      ...
      value: function ofSVGPath(svgPath) {
        try {
          ...
          var _trimmedPath$match$sp = trimmedPath.match( /*#__PURE__*/_wrapRegExp(/^M *([\.0-9]+),([\.0-9]+)/, {
            x: 1,
            y: 2
          ...
          var cCoords = trimmedPath.replace(/^M.*C */, "").replace(/ *$/, "").split(/[ ,]/).map(safeParseCoordinate);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ../ease/Ease */ "./src/gui/model/ease/Ease.js"), __webpack_require__(/*! ./EasePresetProps */ "./src/gui/model/preset/EasePresetProps.js"), __webpack_require__(/*! ./enum/Curve */ "./src/gui/model/preset/enum/Curve.js"), __webpack_require__(/*! ./enum/Orientation */ "./src/gui/model/preset/enum/Orientation.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _Ease, _EasePresetProps, _Curve, _Orientation) {
  "use strict";
  ...
  _exports["default"] = void 0;
  _Ease = _interopRequireDefault(_Ease);
  _EasePresetProps = _interopRequireDefault(_EasePresetProps);
  ...
  var EasePreset = /*#__PURE__*/function () {
    function EasePreset(easeOrSvgPath) {
      ...
      this.props = new _EasePresetProps["default"](this);
    }

    _createClass(EasePreset, [{
      key: "clone",
      value: function clone() {
        var clone = EasePreset.of(this.ease.toString(), this.curve, this.orientation);

        var _iterator = _createForOfIteratorHelper(this.props.entries()),
            _step;
      ...
      key: "property",
      value: function property(propertyName, defaultValue, watcherFn) {
...
/***/ "./src/gui/model/preset/EasePresetProps.js":
/*!*************************************************!*\
  !*** ./src/gui/model/preset/EasePresetProps.js ***!
  \*************************************************/
/***/ (function(module, exports) {
...
(function (global, factory) {
  ...
  var EasePresetProps = /*#__PURE__*/function (_Map) {
    _inherits(EasePresetProps, _Map);

    var _super = _createSuper(EasePresetProps);

    function EasePresetProps(preset) {
      var _this;

      _classCallCheck(this, EasePresetProps);

      _this = _super.call(this);
      _this._preset = preset;
      _this._watchers = new Map();
      return _this;
    }

    _createClass(EasePresetProps, [{
      key: "add",
      value: function add(propertyName, defaultValue, watcherFn) {
      ...
      value: function set(propertyName, value) {
        _get(_getPrototypeOf(EasePresetProps.prototype), "set", this).call(this, propertyName, value);

        if (this._watchers.has(propertyName)) {
          var watcherFn = this._watchers.get(propertyName);
    ...
    return EasePresetProps;
  }( /*#__PURE__*/_wrapNativeSuper(Map));

  _exports["default"] = EasePresetProps;
});
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var EasePresetProvider = /*#__PURE__*/function () {
    ...
    _createClass(EasePresetProvider, [{
      ...
      key: "property",
      value: function property(propertyName, defaultValue) {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! ../property.html */ "./src/gui/view/dom/property.html"), __webpack_require__(/*! ../../HTMLElementDirector */ "./src/gui/view/HTMLElementDirector.js"), __webpack_require__(/*! ../selectors */ "./src/gui/view/dom/selectors.js"), __webpack_require__(/*! dat.gui */ "dat.gui")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
		__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
		(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
		__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _property, _HTMLElementDirector2, _selectors, _dat) {
  "use strict";
  ...
  var StringController = _dat.controllers.StringController,
      NumberController = _dat.controllers.NumberControllerBox,
  ...
  var EasePropertiesDirector = /*#__PURE__*/function (_HTMLElementDirector) {
    ...
    function EasePropertiesDirector(rootDomElement) {
      ...
      return _super.call(this, (0, _selectors.propertiesContainer)(rootDomElement));
    }
      ...
      set: function set(props) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var controller = createDatGuiController(propertyName, propertyValue);

            var propertyElement = _renderTemplate(_property["default"]);

            var className = _typeof(propertyValue);
            ...
            controller.onChange(function (arg1, arg2) {
  ...
  function createDatGuiController(propertyName, propertyValue) {
    var config = _defineProperty({}, propertyName, propertyValue);
  ...
  var InstanceCastEntry = /*#__PURE__*/function (_CastEntry) {
    ...
    _createClass(InstanceCastEntry, [{
      ...
      value: function _parseNativePreset(rawNativePreset) {
        ...
        if (rawNativePreset instanceof _EasePresetProvider["default"] || typeof rawNativePreset.next === "function") {
          return rawNativePreset.next();
        } else if (rawNativePreset instanceof _EasePreset["default"] || typeof rawNativePreset.clone === "function") {
